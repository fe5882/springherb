...
public class ReBoardVO {
	/*
	 * private int no; private String name; private String pwd; private String
	 * title; private String email; private Timestamp regdate; private int
	 * readcount; private String content; private int newImgTerm; //24시간 이내의 글인지
	 * 체크하는 용도
	 */
	...
	private int newImgTerm; //24시간 이내의 글인지 체크하는 용도
	public int getNo() {
		return no;
	}
