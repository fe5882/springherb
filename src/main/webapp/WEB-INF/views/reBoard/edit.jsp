...
<form name="frmEdit" method="post"  enctype="multipart/form-data"
	...
	<legend>글수정</legend>
        ...
        <div>
        	...
        	<input type="file" name = "upfile" id = "upfile" size = "40" value = "${vo.fileName }">
        	<c:if test = "${!empty vo.fileName && vo.fileName != null }">
        	<br>
        	<span style = "width: 70px; color: green"> <p>※ 첨부 파일을 새로 지정할 경우 기존 파일 ${fileInfo }은 삭제됩니다 </p> </span>
        	</c:if>
        </div>
        <div>  
